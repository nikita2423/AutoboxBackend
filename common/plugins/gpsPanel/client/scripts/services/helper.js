        ...
        function ($state, LoginServices, $q, $timeout, Database, SnaphyTemplate, DetailViewResource, $rootScope) {
                            ...
                            if (!settings.get().config.employee) {
                                LoginServices.addUserDetail.get()
                                    .then(function (userObj) {
                                        ...
                                        var workshopService = Database.getDb("gpsPanel", "Workshop");
                    ...
                    tabs: {
                        ...
                        trackVehicle: {
                            ...
                            getLocation: function (dealerId, serialNumber) {
                                var DealerVehicle = Database.getDb("gpsPanel", "DealerVehicle");
                                var TrackDealerVehicle = Database.getDb("gpsPanel", "TrackDealerVehicle");
                                initialize()
                                    .then(function () {
            ...
            var getAllVehicle = function () {
                return $q(function (resolve, reject) {
                    initialize()
                        .then(function (user) {
                            var DealerVehicleService = Database.getDb("gpsPanel", "DealerVehicle");
                            if (user) {
