...
public class WorkshopRepository extends ModelRepository<Workshop> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:workshopId/area", "GET"), "Workshop.prototype.__get__area");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            public void get__area(  String workshopId,  Boolean refresh, final ObjectCallback<Area> callback){
