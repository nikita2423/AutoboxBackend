...
public class CarDb{
  ...
  public CarDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(10) != null){
                          gearBoxIdData = cursor.getString(10);
    ...
    public DataList<Car>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit) {
        DataList<Car> modelList = new DataList<Car>();
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM Car " + whereQuery + " LIMIT " + limit;
            }else{
                selectQuery = "SELECT  * FROM Car " + whereQuery;
            }
        }
    ...
    // Getting All Data where
    public DataList<Car>  getAll__db(HashMap<String, Object> whereKeyValue, int limit) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `Car` " + whereQuery + " LIMIT " + limit;
            }else{
                countQuery = "SELECT  * FROM `Car` " + whereQuery;
            }
        }
