...
public class BrandDb{
  ...
  public BrandDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public void insert__db (final String id, final Brand _modelData) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      // Inserting Row
    ...
    public ContentValues getContentValues(Brand _modelData){
      ContentValues values = new ContentValues();
                        ...
                        if(_modelData.getStatus() != null){
                          ...
                          values.put("`status`", statusData);
                                                            ...
                                                            double trendingData;
                        trendingData = (double)_modelData.getTrending();
                        values.put("`trending`", trendingData);
                                  
                                
                                                            String brandNumberData = "";
                        if(_modelData.getBrandNumber() != null){
                          brandNumberData = _modelData.getBrandNumber().toString();
                          values.put("`brandNumber`", brandNumberData);
                        }
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(1) != null){
                          ...
                          if(statusData != null){
                            ...
                            hashMap.put("status", statusData);
                                                            ...
                                                            double trendingData = (double)0;
                          trendingData = cursor.getInt(2);
                          trendingData = (double)trendingData;
                        ...
                        if(cursor.getString(3) != null){
                          brandNumberData = cursor.getString(3);
                          if(brandNumberData != null){
                            brandNumberData = (String)brandNumberData;
                            hashMap.put("brandNumber", brandNumberData);
                          }
                        }
    ...
    public DataList<Brand>  getAll__db(HashMap<String, Object> whereKeyValue) {
    ...
    public DataList<Brand>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip) {
        DataList<Brand> modelList = new DataList<Brand>();
        String whereQuery = getWhereQuery(whereKeyValue);
        String selectQuery;
        if(orderBy != null){
            selectQuery = "SELECT  * FROM `Brand` " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM Brand " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
            }else{
                selectQuery = "SELECT  * FROM Brand " + whereQuery  + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    // Getting All Data where
    public DataList<Brand>  getAll__db(HashMap<String, Object> whereKeyValue, int limit, int skip) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip){
        ...
        String countQuery;
        if(orderBy != null){
            countQuery = "SELECT  * FROM `Brand` " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `Brand` " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
            }else{
                countQuery = "SELECT  * FROM `Brand` " + whereQuery + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    public void checkOldData__db(final HashMap<String, Object> whereKeyValue) {
            ...
            // updating row
            db.update("`Brand`", values, "_DATA_UPDATED = 1 AND " + where, null);
    }
    ...
    public void deleteOldData__db(final HashMap<String, Object> whereKeyValue) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      String where = getWhere(whereKeyValue);
      db.delete("`Brand`", "_DATA_UPDATED = 0 AND " + where , null);
    }
    ...
    public void updateAll__db(final HashMap<String, Object> whereKeyValue, final Brand _modelData ){
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      ContentValues values = getContentValues(_modelData);
      String where = getWhere(whereKeyValue);
      db.update("`Brand`", values, where, null);
    }
    ...
    public void update__db(final String id,   final Brand _modelData) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      ContentValues values = getContentValues(_modelData);
      // updating row
      db.update("`Brand`", values, "id = ?", new String[] { id });
    }
