...
public class ChauffeurDb{
  ...
  public ChauffeurDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public DataList<Chauffeur>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip) {
        DataList<Chauffeur> modelList = new DataList<Chauffeur>();
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM Chauffeur " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
            }else{
                selectQuery = "SELECT  * FROM Chauffeur " + whereQuery  + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    // Getting All Data where
    public DataList<Chauffeur>  getAll__db(HashMap<String, Object> whereKeyValue, int limit, int skip) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `Chauffeur` " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
            }else{
                countQuery = "SELECT  * FROM `Chauffeur` " + whereQuery + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    public void update__db(final String id,   final Chauffeur _modelData) {
      ...
      ContentValues values = getContentValues(_modelData);
      // updating row
      db.update("`Chauffeur`", values, "id = ?", new String[] { id });
    }
