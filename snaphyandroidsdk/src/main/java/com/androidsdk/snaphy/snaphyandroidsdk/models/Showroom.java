...
public class Showroom extends Model {
    ...
    public Showroom (){
        that = this;
                ...
                public void setSalesConsultantName(String salesConsultantName){
                    ...
                    //Update hashMap value..
                    hashMap.put("salesConsultantName", salesConsultantName);
                }
                ...
                public void setGeneralManagerEmail(String generalManagerEmail){
                    ...
                    //Update hashMap value..
                    hashMap.put("generalManagerEmail", generalManagerEmail);
                }
                ...
                /* Adding Getter and Setter methods */
                public String getShowroomNumber(){
                    return showroomNumber;
                }

                /* Adding Getter and Setter methods */
                public void setShowroomNumber(String showroomNumber){
                    this.showroomNumber = showroomNumber;
                    //Update hashMap value..
                    hashMap.put("showroomNumber", showroomNumber);
                }
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      ShowroomRepository lowercaseFirstLetterRepository = (ShowroomRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public Brand getBrand() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(brand == null){
                                        ShowroomRepository showroomRepository = (ShowroomRepository) getRepository();

                                        RestAdapter restAdapter = showroomRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__brand( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Brand> callback) {
                                        ...
                                        //Define methods here..
                                        final ShowroomRepository  showroomRepo = restAdapter.createRepository(ShowroomRepository.class);
                                        ...
                                        showroomRepo.get__brand( (String)that.getId(), refresh,  new ObjectCallback<Brand> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__dealer( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Dealer> callback) {
                                        ...
                                        showroomRepo.get__dealer( (String)that.getId(), refresh,  new ObjectCallback<Dealer> (){
                    ...
                    */
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void findById__cities( String fk,  RestAdapter restAdapter, final ObjectCallback<City> callback) {
                                        ...
                                        showroomRepo.findById__cities( (String)that.getId(), fk,  new ObjectCallback<City> (){
                                    ...
                                    public void destroyById__cities( String fk,  RestAdapter restAdapter, final VoidCallback callback) {
                                        ...
                                        showroomRepo.destroyById__cities( (String)that.getId(), fk,  new VoidCallback (){
                                    ...
                                    public void updateById__cities( String fk,  City data,  RestAdapter restAdapter, final ObjectCallback<City> callback) {
                                        ...
                                        showroomRepo.updateById__cities( (String)that.getId(), fk, data.convertMap(),  new ObjectCallback<City> (){
                                    ...
                                    public void link__cities( String fk,  RestAdapter restAdapter, final ObjectCallback<City> callback) {
                                        ...
                                        showroomRepo.link__cities( (String)that.getId(), fk,  new ObjectCallback<City> (){
                                    ...
                                    public void unlink__cities( String fk,  RestAdapter restAdapter, final VoidCallback callback) {
                                        ...
                                        showroomRepo.unlink__cities( (String)that.getId(), fk,  new VoidCallback (){
                                    ...
                                    public void exists__cities( String fk,  RestAdapter restAdapter, final ObjectCallback<JSONObject>  callback) {
                                        ...
                                        showroomRepo.exists__cities( (String)that.getId(), fk,  new ObjectCallback<JSONObject>(){
                                    ...
                                    public void get__cities( Map<String,  ? extends Object> filter,  RestAdapter restAdapter, final DataListCallback<City> callback) {
                                        ...
                                        showroomRepo.get__cities( (String)that.getId(), filter,  new DataListCallback<City> (){
                                    ...
                                    public void create__cities( City data,  RestAdapter restAdapter, final ObjectCallback<City> callback) {
                                        ...
                                        showroomRepo.create__cities( (String)that.getId(), data.convertMap(),  new ObjectCallback<City> (){
                                    ...
                                    public void delete__cities( RestAdapter restAdapter, final VoidCallback callback) {
                                        ...
                                        showroomRepo.delete__cities( (String)that.getId(),  new VoidCallback (){
                                    ...
                                    public void count__cities( Map<String,  ? extends Object> where,  RestAdapter restAdapter, final ObjectCallback<JSONObject>  callback) {
                                        ...
                                        showroomRepo.count__cities( (String)that.getId(), where,  new ObjectCallback<JSONObject>(){
                    ...
                    */
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void findById__areas( String fk,  RestAdapter restAdapter, final ObjectCallback<Area> callback) {
                                        ...
                                        showroomRepo.findById__areas( (String)that.getId(), fk,  new ObjectCallback<Area> (){
                                    ...
                                    public void destroyById__areas( String fk,  RestAdapter restAdapter, final VoidCallback callback) {
                                        ...
                                        showroomRepo.destroyById__areas( (String)that.getId(), fk,  new VoidCallback (){
                                    ...
                                    public void updateById__areas( String fk,  Area data,  RestAdapter restAdapter, final ObjectCallback<Area> callback) {
                                        ...
                                        showroomRepo.updateById__areas( (String)that.getId(), fk, data.convertMap(),  new ObjectCallback<Area> (){
                                    ...
                                    public void link__areas( String fk,  RestAdapter restAdapter, final ObjectCallback<Area> callback) {
                                        ...
                                        showroomRepo.link__areas( (String)that.getId(), fk,  new ObjectCallback<Area> (){
                                    ...
                                    public void unlink__areas( String fk,  RestAdapter restAdapter, final VoidCallback callback) {
                                        ...
                                        showroomRepo.unlink__areas( (String)that.getId(), fk,  new VoidCallback (){
                                    ...
                                    public void exists__areas( String fk,  RestAdapter restAdapter, final ObjectCallback<JSONObject>  callback) {
                                        ...
                                        showroomRepo.exists__areas( (String)that.getId(), fk,  new ObjectCallback<JSONObject>(){
                                    ...
                                    public void get__areas( Map<String,  ? extends Object> filter,  RestAdapter restAdapter, final DataListCallback<Area> callback) {
                                        ...
                                        showroomRepo.get__areas( (String)that.getId(), filter,  new DataListCallback<Area> (){
                                    ...
                                    public void create__areas( Area data,  RestAdapter restAdapter, final ObjectCallback<Area> callback) {
                                        ...
                                        showroomRepo.create__areas( (String)that.getId(), data.convertMap(),  new ObjectCallback<Area> (){
                                    ...
                                    public void delete__areas( RestAdapter restAdapter, final VoidCallback callback) {
                                        ...
                                        showroomRepo.delete__areas( (String)that.getId(),  new VoidCallback (){
                                    ...
                                    public void count__areas( Map<String,  ? extends Object> where,  RestAdapter restAdapter, final ObjectCallback<JSONObject>  callback) {
                                        ...
                                        showroomRepo.count__areas( (String)that.getId(), where,  new ObjectCallback<JSONObject>(){
