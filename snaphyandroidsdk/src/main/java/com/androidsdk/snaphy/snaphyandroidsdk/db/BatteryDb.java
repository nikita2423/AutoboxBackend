...
public class BatteryDb{
  ...
  public BatteryDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public DataList<Battery>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit) {
        DataList<Battery> modelList = new DataList<Battery>();
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM Battery " + whereQuery + " LIMIT " + limit;
            }else{
                selectQuery = "SELECT  * FROM Battery " + whereQuery;
            }
        }
    ...
    // Getting All Data where
    public DataList<Battery>  getAll__db(HashMap<String, Object> whereKeyValue, int limit) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `Battery` " + whereQuery + " LIMIT " + limit;
            }else{
                countQuery = "SELECT  * FROM `Battery` " + whereQuery;
            }
        }
