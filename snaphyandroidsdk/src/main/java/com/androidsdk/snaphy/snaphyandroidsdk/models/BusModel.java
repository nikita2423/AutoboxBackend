...
public class BusModel extends Model {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      BusModelRepository lowercaseFirstLetterRepository = (BusModelRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public School getSchool() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(school == null){
                                        BusModelRepository busModelRepository = (BusModelRepository) getRepository();

                                        RestAdapter restAdapter = busModelRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__school( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<School> callback) {
                                        ...
                                        //Define methods here..
                                        final BusModelRepository  busModelRepo = restAdapter.createRepository(BusModelRepository.class);
                                        ...
                                        busModelRepo.get__school( (String)that.getId(), refresh,  new ObjectCallback<School> (){
