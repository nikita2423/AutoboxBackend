...
public class ShowroomDb{
  ...
  public ShowroomDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
      ...
      ContentValues values = new ContentValues();
                        ...
                        if(_modelData.getStatus() != null){
                          ...
                          values.put("`status`", statusData);
                                                            ...
                                                            String generalManagerEmailData = "";
                        if(_modelData.getGeneralManagerEmail() != null){
                          generalManagerEmailData = _modelData.getGeneralManagerEmail().toString();
                          values.put("`generalManagerEmail`", generalManagerEmailData);
                        }
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(1) != null){
                          salesConsultantNameData = cursor.getString(1);
                        ...
                        if(cursor.getString(4) != null){
                          ...
                          gsonBuilder.setLongSerializationPolicy(LongSerializationPolicy.STRING);
                          Gson gson = gsonBuilder.create();
                           latlongData = gson.fromJson(cursor.getString(4), Map.class);
                          if(latlongData != null){
                        ...
                        if(cursor.getString(6) != null){
                          generalManagerEmailData = cursor.getString(6);
                          if(generalManagerEmailData != null){
                            generalManagerEmailData = (String)generalManagerEmailData;
                            hashMap.put("generalManagerEmail", generalManagerEmailData);
                          }
                        }
                        ...
                        if(cursor.getString(7) != null){
                          addressData = cursor.getString(7);
                          if(addressData != null){
                        ...
                        if(cursor.getString(8) != null){
                          ...
                          gsonBuilder.setLongSerializationPolicy(LongSerializationPolicy.STRING);
                          Gson gson = gsonBuilder.create();
                           timingsData = gson.fromJson(cursor.getString(8), Map.class);
                          if(timingsData != null){
                        ...
                        if(cursor.getString(9) != null){
                          landlineData = cursor.getString(9);
                        ...
                        if(cursor.getString(10) != null){
                          showroomNumberData = cursor.getString(10);
                        ...
                        if(cursor.getString(11) != null){
                          ...
                          gsonBuilder.setLongSerializationPolicy(LongSerializationPolicy.STRING);
                          Gson gson = gsonBuilder.create();
                           imageData = gson.fromJson(cursor.getString(11), Map.class);
                          if(imageData != null){
                        ...
                        if(cursor.getString(12) != null){
                          ...
                          gsonBuilder.setLongSerializationPolicy(LongSerializationPolicy.STRING);
                          Gson gson = gsonBuilder.create();
                           managerImageData = gson.fromJson(cursor.getString(12), Map.class);
                        ...
                        if(cursor.getString(14) != null){
                          updatedData = cursor.getString(14);
                          if(updatedData != null){
                        ...
                        if(cursor.getString(16) != null){
                          brandIdData = cursor.getString(16);
                          if(brandIdData != null){
                        ...
                        if(cursor.getString(17) != null){
                          dealerIdData = cursor.getString(17);
    ...
    public DataList<Showroom>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip) {
        DataList<Showroom> modelList = new DataList<Showroom>();
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM Showroom " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
            }else{
                selectQuery = "SELECT  * FROM Showroom " + whereQuery  + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    // Getting All Data where
    public DataList<Showroom>  getAll__db(HashMap<String, Object> whereKeyValue, int limit, int skip) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `Showroom` " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
            }else{
                countQuery = "SELECT  * FROM `Showroom` " + whereQuery + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    public void update__db(final String id,   final Showroom _modelData) {
      ...
      ContentValues values = getContentValues(_modelData);
      // updating row
      db.update("`Showroom`", values, "id = ?", new String[] { id });
    }
