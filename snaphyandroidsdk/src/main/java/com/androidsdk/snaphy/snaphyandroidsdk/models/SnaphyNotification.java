...
public class SnaphyNotification extends Model {
    ...
    private SnaphyNotification that ;

    public SnaphyNotification (){
        that = this;
    }
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      SnaphyNotificationRepository lowercaseFirstLetterRepository = (SnaphyNotificationRepository) getRepository();
