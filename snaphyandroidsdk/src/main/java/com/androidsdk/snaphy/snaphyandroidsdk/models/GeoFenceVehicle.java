...
public class GeoFenceVehicle extends Model {
    ...
    public GeoFenceVehicle (){
        that = this;
                ...
                public void setHomeLocationAddress(String homeLocationAddress){
                    ...
                    //Update hashMap value..
                    hashMap.put("homeLocationAddress", homeLocationAddress);
                }
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      GeoFenceVehicleRepository lowercaseFirstLetterRepository = (GeoFenceVehicleRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public Customer getCustomer() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(customer == null){
                                        GeoFenceVehicleRepository geoFenceVehicleRepository = (GeoFenceVehicleRepository) getRepository();

                                        RestAdapter restAdapter = geoFenceVehicleRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__customer( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Customer> callback) {
                                        ...
                                        //Define methods here..
                                        final GeoFenceVehicleRepository  geoFenceVehicleRepo = restAdapter.createRepository(GeoFenceVehicleRepository.class);
                                        ...
                                        geoFenceVehicleRepo.get__customer( (String)that.getId(), refresh,  new ObjectCallback<Customer> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__vehicleDetail( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<VehicleDetail> callback) {
                                        ...
                                        geoFenceVehicleRepo.get__vehicleDetail( (String)that.getId(), refresh,  new ObjectCallback<VehicleDetail> (){
