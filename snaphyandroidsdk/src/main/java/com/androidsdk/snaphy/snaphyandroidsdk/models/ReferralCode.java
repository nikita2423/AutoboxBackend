...
public class ReferralCode extends Model {
    ...
    public ReferralCode (){
        that = this;
                ...
                public void setCodeCount(double codeCount){
                    ...
                    //Update hashMap value..
                    hashMap.put("codeCount", codeCount);
                }
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      ReferralCodeRepository lowercaseFirstLetterRepository = (ReferralCodeRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public Customer getCustomer() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(customer == null){
                                        ReferralCodeRepository referralCodeRepository = (ReferralCodeRepository) getRepository();

                                        RestAdapter restAdapter = referralCodeRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__customer( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Customer> callback) {
                                        ...
                                        //Define methods here..
                                        final ReferralCodeRepository  referralCodeRepo = restAdapter.createRepository(ReferralCodeRepository.class);
                                        ...
                                        referralCodeRepo.get__customer( (String)that.getId(), refresh,  new ObjectCallback<Customer> (){
