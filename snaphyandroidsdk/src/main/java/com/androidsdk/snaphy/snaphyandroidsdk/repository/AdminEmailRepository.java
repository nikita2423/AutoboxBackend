...
public class AdminEmailRepository extends ModelRepository<AdminEmail> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/preVehicleBooking", "POST"), "adminEmail.preVehicleBooking");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            //Method preVehicleBooking definition
            public void preVehicleBooking(  DataList<String> to,  String subject,  Map<String,  ? extends Object> templateOptions, final ObjectCallback<JSONObject>  callback ){
                ...
                */
                ...
                //Now add the arguments...
                    ...
                    invokeStaticMethod("preVehicleBooking", hashMapObject, new Adapter.JsonObjectCallback() {
            ...
            }//Method preVehicleBooking definition ends here..
