...
public class QuoteReplyRepository extends ModelRepository<QuoteReply> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/createQuoteReply", "POST"), "QuoteReply.createQuoteReply");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            //Method createQuoteReply definition
            public void createQuoteReply(  Map<String,  ? extends Object> ctx,  Map<String,  ? extends Object> quoteReplyObj, final ObjectCallback<JSONObject>  callback ){
                ...
                */
                ...
                //Now add the arguments...
                        ...
                        hashMapObject.put("quoteReplyObj", quoteReplyObj);
                    ...
                    invokeStaticMethod("createQuoteReply", hashMapObject, new Adapter.JsonObjectCallback() {
            ...
            }//Method createQuoteReply definition ends here..
            ...
            public void fetchQuoteReplyFromDealer(  Map<String,  ? extends Object> ctx,  Map<String,  ? extends Object> filter,  double lat,  double lang, final ObjectCallback<JSONObject>  callback ){
