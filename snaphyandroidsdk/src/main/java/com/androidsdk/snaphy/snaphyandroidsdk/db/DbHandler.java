...
public class DbHandler extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
                        ...
                        String CREATE_OldTradeCar_TABLE_47 = "CREATE TABLE IF NOT EXISTS `OldTradeCar` (  `registeredCity` TEXT, `added` TEXT, `updated` TEXT, `miles` NUMBER, `id` TEXT PRIMARY KEY, `cityId` TEXT, `customerId` TEXT, `carModelId` TEXT, `brandId` TEXT, `trimId` TEXT, _DATA_UPDATED NUMBER )";
                        ...
                        String CREATE_SoldViaAutobox_TABLE_55 = "CREATE TABLE IF NOT EXISTS `SoldViaAutobox` (  `type` TEXT, `id` TEXT PRIMARY KEY, `vehicleInfoId` TEXT, `dealerId` TEXT, `customerId` TEXT, `customerQuoteId` TEXT, `vehicleDetailId` TEXT, _DATA_UPDATED NUMBER )";
