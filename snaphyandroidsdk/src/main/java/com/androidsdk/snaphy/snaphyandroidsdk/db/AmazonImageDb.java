...
public class AmazonImageDb{
  ...
  public AmazonImageDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public ContentValues getContentValues(AmazonImage _modelData){
      ContentValues values = new ContentValues();
                        ...
                        if(_modelData.getContainer() != null){
                          containerData = _modelData.getContainer().toString();
                        ...
                        if(_modelData.getUrl() != null){
                          ...
                          urlData = gson.toJson(_modelData.getUrl(), HashMap.class);
    ...
    public DataList<AmazonImage>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip) {
        DataList<AmazonImage> modelList = new DataList<AmazonImage>();
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM AmazonImage " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
            }else{
                selectQuery = "SELECT  * FROM AmazonImage " + whereQuery  + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    // Getting All Data where
    public DataList<AmazonImage>  getAll__db(HashMap<String, Object> whereKeyValue, int limit, int skip) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `AmazonImage` " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
            }else{
                countQuery = "SELECT  * FROM `AmazonImage` " + whereQuery + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    public void update__db(final String id,   final AmazonImage _modelData) {
      ...
      ContentValues values = getContentValues(_modelData);
      // updating row
      db.update("`AmazonImage`", values, "id = ?", new String[] { id });
    }
