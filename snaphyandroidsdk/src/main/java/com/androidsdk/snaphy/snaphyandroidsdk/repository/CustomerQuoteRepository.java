...
public class CustomerQuoteRepository extends ModelRepository<CustomerQuote> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:customerQuoteId/dealer", "GET"), "CustomerQuote.prototype.__get__dealer");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            public void get__dealer(  String customerQuoteId,  Boolean refresh, final ObjectCallback<Dealer> callback){
