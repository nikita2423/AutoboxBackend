...
public class CompanyInfoDb{
  ...
  public CompanyInfoDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public DataList<CompanyInfo>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip) {
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                ...
                selectQuery = "SELECT  * FROM CompanyInfo " + whereQuery  + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                ...
                countQuery = "SELECT  * FROM `CompanyInfo` " + whereQuery + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    public void update__db(final String id,   final CompanyInfo _modelData) {
      ...
      ContentValues values = getContentValues(_modelData);
      // updating row
      db.update("`CompanyInfo`", values, "id = ?", new String[] { id });
    }
