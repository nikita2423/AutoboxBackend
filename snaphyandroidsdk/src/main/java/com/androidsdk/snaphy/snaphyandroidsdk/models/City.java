    ...
    //Now adding relations between related models
                    ...
                    public Country getCountry() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(country == null){
                                        CityRepository cityRepository = (CityRepository) getRepository();

                                        RestAdapter restAdapter = cityRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__country( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Country> callback) {
                                        ...
                                        cityRepo.get__country( (String)that.getId(), refresh,  new ObjectCallback<Country> (){
