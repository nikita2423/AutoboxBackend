...
public class SchoolDb{
  ...
  public SchoolDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public DataList<School>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit) {
        DataList<School> modelList = new DataList<School>();
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM School " + whereQuery + " LIMIT " + limit;
            }else{
                selectQuery = "SELECT  * FROM School " + whereQuery;
            }
        }
    ...
    // Getting All Data where
    public DataList<School>  getAll__db(HashMap<String, Object> whereKeyValue, int limit) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `School` " + whereQuery + " LIMIT " + limit;
            }else{
                countQuery = "SELECT  * FROM `School` " + whereQuery;
            }
        }
