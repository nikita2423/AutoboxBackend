...
public class TrackBus extends Model {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      TrackBusRepository lowercaseFirstLetterRepository = (TrackBusRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public Customer getCustomer() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(customer == null){
                                        TrackBusRepository trackBusRepository = (TrackBusRepository) getRepository();

                                        RestAdapter restAdapter = trackBusRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__customer( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Customer> callback) {
                                        ...
                                        //Define methods here..
                                        final TrackBusRepository  trackBusRepo = restAdapter.createRepository(TrackBusRepository.class);
                                        ...
                                        trackBusRepo.get__customer( (String)that.getId(), refresh,  new ObjectCallback<Customer> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__busModel( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<BusModel> callback) {
                                        ...
                                        trackBusRepo.get__busModel( (String)that.getId(), refresh,  new ObjectCallback<BusModel> (){
