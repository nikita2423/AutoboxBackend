...
//Now import model of related models..
            ...
            import com.androidsdk.snaphy.snaphyandroidsdk.models.PlanType;
...
public class CustomerRepository extends UserRepository<Customer> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:customerId/bus", "GET"), "Customer.prototype.__get__bus");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:customerId/planType", "GET"), "Customer.prototype.__get__planType");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/incrementReferralCount", "POST"), "Customer.incrementReferralCount");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/setOfferNotificationStatus", "POST"), "Customer.setOfferNotificationStatus");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/setGpsNotificationStatus", "POST"), "Customer.setGpsNotificationStatus");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/incrementShareAppCount", "POST"), "Customer.incrementShareAppCount");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/incrementPoints", "POST"), "Customer.incrementPoints");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            //Method get__bus definition
            public void get__bus(  String customerId,  Boolean refresh, final ObjectCallback<Bus> callback){
                ...
                */
                ...
                //Now add the arguments...
                    ...
                    invokeStaticMethod("prototype.__get__bus", hashMapObject, new Adapter.JsonObjectCallback() {
            ...
            }//Method get__bus definition ends here..
            ...
            //Method get__planType definition
            public void get__planType(  String customerId,  Boolean refresh, final ObjectCallback<PlanType> callback){
                ...
                */
                ...
                //Now add the arguments...
                    ...
                    invokeStaticMethod("prototype.__get__planType", hashMapObject, new Adapter.JsonObjectCallback() {
                        ...
                        public void onSuccess(JSONObject response) {
                                ...
                                if(response != null){
                                    PlanTypeRepository planTypeRepo = getRestAdapter().createRepository(PlanTypeRepository.class);
                                    if(context != null){
                                        try {
                                            Method method = planTypeRepo.getClass().getMethod("addStorage", Context.class);
                                            method.invoke(planTypeRepo, context);

                                        } catch (Exception e) {
                                            Log.e("Database Error", e.toString());
                                        }

                                        //planTypeRepo.addStorage(context);
                                    }
                                    Map<String, Object> result = Util.fromJson(response);
                                    PlanType planType = planTypeRepo.createObject(result);

                                      //Add to database if persistent storage required..
                                      if(isSTORE_LOCALLY()){
                                          //http://stackoverflow.com/questions/160970/how-do-i-invoke-a-java-method-when-given-the-method-name-as-a-string
                                          try {
                                                    Method method = planType.getClass().getMethod("save__db");
                                                    method.invoke(planType);
            ...
            }//Method get__planType definition ends here..
            ...
            //Method incrementReferralCount definition
            public void incrementReferralCount(  String referralCode, final ObjectCallback<JSONObject>  callback ){
                ...
                */
                ...
                //Now add the arguments...
                    ...
                    invokeStaticMethod("incrementReferralCount", hashMapObject, new Adapter.JsonObjectCallback() {
            ...
            }//Method incrementReferralCount definition ends here..
            ...
            //Method setOfferNotificationStatus definition
            public void setOfferNotificationStatus(  Map<String,  ? extends Object> ctx,  Map<String,  ? extends Object> customerOfferObj, final ObjectCallback<JSONObject>  callback ){
                ...
                */
                ...
                //Now add the arguments...
                        ...
                        hashMapObject.put("customerOfferObj", customerOfferObj);
                    ...
                    invokeStaticMethod("setOfferNotificationStatus", hashMapObject, new Adapter.JsonObjectCallback() {
            ...
            }//Method setOfferNotificationStatus definition ends here..
            ...
            //Method setGpsNotificationStatus definition
            public void setGpsNotificationStatus(  Map<String,  ? extends Object> ctx,  Map<String,  ? extends Object> customerNotificationObj, final ObjectCallback<JSONObject>  callback ){
                ...
                */
                ...
                //Now add the arguments...
                        ...
                        hashMapObject.put("customerNotificationObj", customerNotificationObj);
                    ...
                    invokeStaticMethod("setGpsNotificationStatus", hashMapObject, new Adapter.JsonObjectCallback() {
            ...
            }//Method setGpsNotificationStatus definition ends here..
            ...
            //Method incrementShareAppCount definition
            public void incrementShareAppCount(  Map<String,  ? extends Object> ctx,  String contactNumber, final ObjectCallback<JSONObject>  callback ){
                ...
                */
                ...
                //Now add the arguments...
                        ...
                        hashMapObject.put("contactNumber", contactNumber);
                    ...
                    invokeStaticMethod("incrementShareAppCount", hashMapObject, new Adapter.JsonObjectCallback() {
            ...
            }//Method incrementShareAppCount definition ends here..
            ...
            //Method incrementPoints definition
            public void incrementPoints(  Map<String,  ? extends Object> ctx,  String phoneNumber, final ObjectCallback<JSONObject>  callback ){
                ...
                */
                ...
                //Now add the arguments...
                    ...
                    invokeStaticMethod("incrementPoints", hashMapObject, new Adapter.JsonObjectCallback() {
            ...
            }//Method incrementPoints definition ends here..
