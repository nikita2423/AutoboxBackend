...
public class CustomerQuoteDb{
  ...
  public CustomerQuoteDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(0) != null){
                          ownershipTypeData = cursor.getString(0);
                        ...
                        if(cursor.getString(1) != null){
                          isFinanceData = cursor.getString(1);
                        ...
                        if(cursor.getString(2) != null){
                          isInsuranceData = cursor.getString(2);
                        ...
                        if(cursor.getString(3) != null){
                          isOldVehicleTradeData = cursor.getString(3);
                        ...
                        if(cursor.getString(4) != null){
                          quoteTypeData = cursor.getString(4);
                        ...
                        if(cursor.getString(6) != null){
                          purchaseStatusData = cursor.getString(6);
                        ...
                        if(cursor.getString(7) != null){
                          purchaseDateData = cursor.getString(7);
                        ...
                        if(cursor.getString(8) != null){
                          gpsTrackerData = cursor.getString(8);
                        ...
                        if(cursor.getString(9) != null){
                          dashCameraData = cursor.getString(9);
                        ...
                        if(cursor.getString(10) != null){
                          testDriveData = cursor.getString(10);
                        ...
                        if(cursor.getString(11) != null){
                          quoteNumberData = cursor.getString(11);
                        ...
                        if(cursor.getString(17) != null){
                          carModelIdData = cursor.getString(17);
                        ...
                        if(cursor.getString(18) != null){
                          customerIdData = cursor.getString(18);
                        ...
                        if(cursor.getString(20) != null){
                          trimIdData = cursor.getString(20);
                          if(trimIdData != null){
                        ...
                        if(cursor.getString(21) != null){
                          vehicleInfoIdData = cursor.getString(21);
    ...
    public DataList<CustomerQuote>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit) {
        DataList<CustomerQuote> modelList = new DataList<CustomerQuote>();
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM CustomerQuote " + whereQuery + " LIMIT " + limit;
            }else{
                selectQuery = "SELECT  * FROM CustomerQuote " + whereQuery;
            }
        }
    ...
    // Getting All Data where
    public DataList<CustomerQuote>  getAll__db(HashMap<String, Object> whereKeyValue, int limit) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `CustomerQuote` " + whereQuery + " LIMIT " + limit;
            }else{
                countQuery = "SELECT  * FROM `CustomerQuote` " + whereQuery;
            }
        }
    ...
    public void update__db(final String id,   final CustomerQuote _modelData) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                ContentValues values = getContentValues(_modelData);
                // updating row
                db.update("`CustomerQuote`", values, "id = ?",
                        new String[] { id });
                db.setTransactionSuccessful();
                db.endTransaction();
                //db.close();
