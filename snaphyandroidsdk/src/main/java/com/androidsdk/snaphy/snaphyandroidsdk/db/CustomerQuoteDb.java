    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(6) != null){
                          onRoadPriceData = cursor.getString(6);
                        ...
                        if(cursor.getString(7) != null){
                          purchaseStatusData = cursor.getString(7);
                        ...
                        if(cursor.getString(8) != null){
                          purchaseDateData = cursor.getString(8);
                        ...
                        if(cursor.getString(9) != null){
                          gpsTrackerData = cursor.getString(9);
                        ...
                        if(cursor.getString(10) != null){
                          dashCameraData = cursor.getString(10);
                        ...
                        if(cursor.getString(11) != null){
                          testDriveData = cursor.getString(11);
                        ...
                        if(cursor.getString(12) != null){
                          quoteNumberData = cursor.getString(12);
                        ...
                        if(cursor.getString(13) != null){
                          currentBrandIdData = cursor.getString(13);
                        ...
                        if(cursor.getString(19) != null){
                          brandIdData = cursor.getString(19);
                          if(brandIdData != null){
                        ...
                        if(cursor.getString(20) != null){
                          carModelIdData = cursor.getString(20);
                        ...
                        if(cursor.getString(21) != null){
                          customerIdData = cursor.getString(21);
                        ...
                        if(cursor.getString(22) != null){
                          dealerIdData = cursor.getString(22);
                        ...
                        if(cursor.getString(23) != null){
                          cityIdData = cursor.getString(23);
                          if(cityIdData != null){
                        ...
                        if(cursor.getString(24) != null){
                          trimIdData = cursor.getString(24);
                          if(trimIdData != null){
                        ...
                        if(cursor.getString(25) != null){
                          vehicleInfoIdData = cursor.getString(25);
