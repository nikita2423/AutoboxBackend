...
public class Trim extends Model {
    ...
    public Trim (){
        that = this;
                ...
                /* Adding Getter and Setter methods */
                public void setTrimNumber(String trimNumber){
                    this.trimNumber = trimNumber;
                    //Update hashMap value..
                    hashMap.put("trimNumber", trimNumber);
                }
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      TrimRepository lowercaseFirstLetterRepository = (TrimRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public Brand getBrand() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(brand == null){
                                        TrimRepository trimRepository = (TrimRepository) getRepository();

                                        RestAdapter restAdapter = trimRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__brand( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Brand> callback) {
                                        ...
                                        //Define methods here..
                                        final TrimRepository  trimRepo = restAdapter.createRepository(TrimRepository.class);
                                        ...
                                        trimRepo.get__brand( (String)that.getId(), refresh,  new ObjectCallback<Brand> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__carModel( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<CarModel> callback) {
                                        ...
                                        trimRepo.get__carModel( (String)that.getId(), refresh,  new ObjectCallback<CarModel> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__fuel( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Fuel> callback) {
                                        ...
                                        trimRepo.get__fuel( (String)that.getId(), refresh,  new ObjectCallback<Fuel> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__gearBox( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<GearBox> callback) {
                                        ...
                                        trimRepo.get__gearBox( (String)that.getId(), refresh,  new ObjectCallback<GearBox> (){
