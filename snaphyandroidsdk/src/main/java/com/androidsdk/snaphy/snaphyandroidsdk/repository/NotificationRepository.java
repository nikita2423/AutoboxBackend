...
public class NotificationRepository extends ModelRepository<Notification> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getDetailSchema", "POST"), "notification.getDetailSchema");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getModelRelationSchema", "POST"), "notification.getModelRelationSchema");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            public void find(  Map<String,  ? extends Object> filter, final DataListCallback<Notification> callback){
