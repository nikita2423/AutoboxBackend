...
import android.content.Context;
import com.androidsdk.snaphy.snaphyandroidsdk.db.DealerDb;
...
public class DealerRepository extends UserRepository<Dealer> {
    ...
    public DealerRepository(){
        super("Dealer", null, Dealer.class);
    ...
    public Context getContext(){
        return context;
    		...
    		public Dealer cachedCurrentUser;
            private Object currentUserId;
            private boolean isCurrentUserIdLoaded;

    		public Dealer getCachedCurrentUser(){
    			return cachedCurrentUser;
    		}

    		public void setCachedCurrentUser(Dealer user){
            ...
            public void findCurrentUser(final ObjectCallback<Dealer> callback){
                ...
                this.findById((String)getCurrentUserId(), hashMap, new ObjectCallback<Dealer>() {
                    @Override
                    public void onSuccess(Dealer user){
                        cachedCurrentUser = user;
    ...
    public DealerDb getDb() {
      return dealerDb;
    }

    public void setDealerDb(DealerDb dealerDb) {
    ...
    public void addStorage(Context context){
         ...
         setDealerDb(new DealerDb(context, DATABASE_NAME, getRestAdapter()));
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:dealerId/accessTokens/:fk", "GET"), "Dealer.prototype.__findById__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:dealerId/accessTokens/:fk", "DELETE"), "Dealer.prototype.__destroyById__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:dealerId/accessTokens/:fk", "PUT"), "Dealer.prototype.__updateById__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:dealerId/city", "GET"), "Dealer.prototype.__get__city");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:dealerId/brand", "GET"), "Dealer.prototype.__get__brand");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:dealerId/showroom", "GET"), "Dealer.prototype.__get__showroom");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:dealerId/workshop", "GET"), "Dealer.prototype.__get__workshop");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:dealerId/area", "GET"), "Dealer.prototype.__get__area");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:dealerId/accessTokens", "GET"), "Dealer.prototype.__get__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:dealerId/accessTokens", "POST"), "Dealer.prototype.__create__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:dealerId/accessTokens", "DELETE"), "Dealer.prototype.__delete__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:dealerId/accessTokens/count", "GET"), "Dealer.prototype.__count__accessTokens");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/", "POST"), "Dealer.create");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/", "PUT"), "Dealer.upsert");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:id/exists", "GET"), "Dealer.exists");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:id", "GET"), "Dealer.findById");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/", "GET"), "Dealer.find");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/findOne", "GET"), "Dealer.findOne");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/update", "POST"), "Dealer.updateAll");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:id", "DELETE"), "Dealer.deleteById");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/count", "GET"), "Dealer.count");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:dealerId", "PUT"), "Dealer.prototype.updateAttributes");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/confirm", "GET"), "Dealer.confirm");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/reset", "POST"), "Dealer.resetPassword");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/fetchDealerDetail", "POST"), "Dealer.fetchDealerDetail");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/fetchDealersForBrand", "POST"), "Dealer.fetchDealersForBrand");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getSchema", "POST"), "Dealer.getSchema");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getAbsoluteSchema", "POST"), "Dealer.getAbsoluteSchema");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getAuthorisedRoles", "POST"), "Dealer.getAuthorisedRoles");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getDetailSchema", "POST"), "Dealer.getDetailSchema");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getModelRelationSchema", "POST"), "Dealer.getModelRelationSchema");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            public void findById__accessTokens(  String dealerId,  String fk, final ObjectCallback<AccessToken> callback){
            ...
            public void destroyById__accessTokens(  String dealerId,  String fk, final VoidCallback callback){
            ...
            public void updateById__accessTokens(  String dealerId,  String fk,  Map<String,  ? extends Object> data, final ObjectCallback<AccessToken> callback){
            ...
            public void get__city(  String dealerId,  Boolean refresh, final ObjectCallback<City> callback){
            ...
            public void get__brand(  String dealerId,  Boolean refresh, final ObjectCallback<Brand> callback){
            ...
            public void get__showroom(  String dealerId,  Boolean refresh, final ObjectCallback<Showroom> callback){
            ...
            public void get__workshop(  String dealerId,  Boolean refresh, final ObjectCallback<Workshop> callback){
            ...
            public void get__area(  String dealerId,  Boolean refresh, final ObjectCallback<Area> callback){
            ...
            public void get__accessTokens(  String dealerId,  Map<String,  ? extends Object> filter, final DataListCallback<AccessToken> callback){
            ...
            public void create__accessTokens(  String dealerId,  Map<String,  ? extends Object> data, final ObjectCallback<AccessToken> callback){
            ...
            public void delete__accessTokens(  String dealerId, final VoidCallback callback){
            ...
            public void count__accessTokens(  String dealerId,  Map<String,  ? extends Object> where, final ObjectCallback<JSONObject>  callback ){
            ...
            public void create(  Map<String,  ? extends Object> data, final ObjectCallback<Dealer> callback){
            ...
            public void upsert(  Map<String,  ? extends Object> data, final ObjectCallback<Dealer> callback){
            ...
            public void findById(  String id,  Map<String,  ? extends Object> filter, final ObjectCallback<Dealer> callback){
            ...
            public void find(  Map<String,  ? extends Object> filter, final DataListCallback<Dealer> callback){
                    ...
                    invokeStaticMethod("find", hashMapObject, new Adapter.JsonArrayCallback() {
                        ...
                        public void onSuccess(JSONArray response) {
                                ...
                                if(response != null){
                                    //Now converting jsonObject to list
                                    DataList<Map<String, Object>> result = (DataList) Util.fromJson(response);
                                    DataList<Dealer> dealerList = new DataList<Dealer>();
                                    DealerRepository dealerRepo = getRestAdapter().createRepository(DealerRepository.class);
                                    if(context != null){
                                        try {
                                            Method method = dealerRepo.getClass().getMethod("addStorage", Context.class);
                                    ...
                                    for (Map<String, Object> obj : result) {
                                        ...
                                        Dealer dealer = dealerRepo.createObject(obj);
            ...
            public void findOne(  Map<String,  ? extends Object> filter, final ObjectCallback<Dealer> callback){
            ...
            public void updateAttributes(  String dealerId,  Map<String,  ? extends Object> data, final ObjectCallback<Dealer> callback){
            ...
            //Method fetchDealerDetail definition
            public void fetchDealerDetail(  Map<String,  ? extends Object> ctx,  Object dealerId, final ObjectCallback<Dealer> callback){
                ...
                */
                ...
                //Now add the arguments...
                    ...
                    invokeStaticMethod("fetchDealerDetail", hashMapObject, new Adapter.JsonObjectCallback() {
            ...
            }//Method fetchDealerDetail definition ends here..
            ...
            //Method fetchDealersForBrand definition
            public void fetchDealersForBrand(  Map<String,  ? extends Object> ctx,  String brandId,  String lastDate, final ObjectCallback<JSONObject>  callback ){
                ...
                */
                ...
                //Now add the arguments...
                    ...
                    invokeStaticMethod("fetchDealersForBrand", hashMapObject, new Adapter.JsonObjectCallback() {
            ...
            }//Method fetchDealersForBrand definition ends here..
