...
public class SnaphyNotificationDb{
  ...
  public SnaphyNotificationDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public ContentValues getContentValues(SnaphyNotification _modelData){
    ...
    // Getting single c
    public   SnaphyNotification get__db(String id) {
        if (id != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("SnaphyNotification", null, "id=?", new String[]{id}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    ...
                    if (hashMap != null) {
                        SnaphyNotificationRepository repo = restAdapter.createRepository(SnaphyNotificationRepository.class);
                        repo.addStorage(context);
                        return (SnaphyNotification)repo.createObject(hashMap);
                    } else {
                        return null;
                    }
                }
    ...
    // Getting single cont
    public   SnaphyNotification get__db(String whereKey, String whereKeyValue) {
        if (whereKeyValue != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("`SnaphyNotification`", null, "`" + whereKey + "` =?", new String[]{whereKeyValue}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    return null;
                }else{
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(2) != null){
                          ...
                          gsonBuilder.setLongSerializationPolicy(LongSerializationPolicy.STRING);
                          Gson gson = gsonBuilder.create();
                           onClickData = gson.fromJson(cursor.getString(2), Map.class);
                          if(onClickData != null){
    ...
    public void upsert__db(String id, SnaphyNotification model){
        if(count__db(id) != 0){
            update__db(id, model);
        }else{
            insert__db(id, model);
    ...
    public DataList<SnaphyNotification>  getAll__db() {
        DataList<SnaphyNotification> modelList = new DataList<SnaphyNotification>();
        // Select All Query
        String selectQuery = "SELECT  * FROM `SnaphyNotification`";

        SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
        //http://www.tothenew.com/blog/sqlite-locking-and-transaction-handling-in-android/
        Cursor cursor = db.rawQuery(selectQuery, null);
        if (!cursor.moveToFirst() || cursor.getCount() == 0){
            return (DataList<SnaphyNotification>) modelList;
        }else{
            do {
                ...
                if(hashMap != null){
                    SnaphyNotificationRepository repo = restAdapter.createRepository(SnaphyNotificationRepository.class);
                    repo.addStorage(context);
                    modelList.add((SnaphyNotification)repo.createObject(hashMap));
                }
    ...
    public DataList<SnaphyNotification>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip) {
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                ...
                selectQuery = "SELECT  * FROM SnaphyNotification " + whereQuery  + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                ...
                countQuery = "SELECT  * FROM `SnaphyNotification` " + whereQuery + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    public void checkOldData__db(final HashMap<String, Object> whereKeyValue) {
            ...
            // updating row
            db.update("`SnaphyNotification`", values, "_DATA_UPDATED = 1 AND " + where, null);
    }
    ...
    public void deleteOldData__db(final HashMap<String, Object> whereKeyValue) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      String where = getWhere(whereKeyValue);
      db.delete("`SnaphyNotification`", "_DATA_UPDATED = 0 AND " + where , null);
    }
    ...
    // Getting All Data where
    public DataList<SnaphyNotification>  getAll__db(String whereKey, String whereKeyValue) {
        DataList<SnaphyNotification> modelList = new DataList<SnaphyNotification>();
        // Select All Query
        String selectQuery = "SELECT  * FROM `SnaphyNotification` WHERE `" + whereKey +"` ='"+ whereKeyValue + "'" ;
    ...
    public int count__db(String whereKey, String whereKeyValue){
      String countQuery = "SELECT  * FROM `SnaphyNotification` WHERE `" + whereKey +"` ='"+ whereKeyValue + "'" ;
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
      Cursor cursor = db.rawQuery(countQuery, null);
      int count = cursor.getCount();
      cursor.close();
    ...
    public void checkOldData__db(final String whereKey, final String whereKeyValue) {
      ...
      values.put("_DATA_UPDATED", 0);
      // updating row
      db.update("`SnaphyNotification`", values, "_DATA_UPDATED = 1 AND `" + whereKey + "` = ?", new String[]{whereKeyValue});
    }
    ...
    public void updateAll__db(final HashMap<String, Object> whereKeyValue, final SnaphyNotification _modelData ){
      ...
      ContentValues values = getContentValues(_modelData);
      String where = getWhere(whereKeyValue);
      db.update("`SnaphyNotification`", values, where, null);
    }
    ...
    public void update__db(final String id,   final SnaphyNotification _modelData) {
      ...
      ContentValues values = getContentValues(_modelData);
      // updating row
      db.update("`SnaphyNotification`", values, "id = ?", new String[] { id });
    }
    ...
    public void checkOldData__db() {
      ...
      values.put("_DATA_UPDATED", 0);
      // updating row
      db.update("`SnaphyNotification`", values, "_DATA_UPDATED = 1", null);
    }
