...
public class Feedback extends Model {
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      FeedbackRepository lowercaseFirstLetterRepository = (FeedbackRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public Customer getCustomer() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(customer == null){
                                        FeedbackRepository feedbackRepository = (FeedbackRepository) getRepository();

                                        RestAdapter restAdapter = feedbackRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__customer( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Customer> callback) {
                                        ...
                                        //Define methods here..
                                        final FeedbackRepository  feedbackRepo = restAdapter.createRepository(FeedbackRepository.class);
                                        ...
                                        feedbackRepo.get__customer( (String)that.getId(), refresh,  new ObjectCallback<Customer> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__dealer( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Dealer> callback) {
                                        ...
                                        feedbackRepo.get__dealer( (String)that.getId(), refresh,  new ObjectCallback<Dealer> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__showroom( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Showroom> callback) {
                                        ...
                                        feedbackRepo.get__showroom( (String)that.getId(), refresh,  new ObjectCallback<Showroom> (){
