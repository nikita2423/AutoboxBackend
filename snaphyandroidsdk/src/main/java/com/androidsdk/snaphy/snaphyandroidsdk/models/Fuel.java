...
public class Fuel extends Model {
    ...
    public Fuel (){
        that = this;
                ...
                public void setFuelNumber(String fuelNumber){
                    ...
                    //Update hashMap value..
                    hashMap.put("fuelNumber", fuelNumber);
                }
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      FuelRepository lowercaseFirstLetterRepository = (FuelRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public Brand getBrand() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(brand == null){
                                        FuelRepository fuelRepository = (FuelRepository) getRepository();

                                        RestAdapter restAdapter = fuelRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__brand( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Brand> callback) {
                                        ...
                                        //Define methods here..
                                        final FuelRepository  fuelRepo = restAdapter.createRepository(FuelRepository.class);
                                        ...
                                        fuelRepo.get__brand( (String)that.getId(), refresh,  new ObjectCallback<Brand> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__carModel( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<CarModel> callback) {
                                        ...
                                        fuelRepo.get__carModel( (String)that.getId(), refresh,  new ObjectCallback<CarModel> (){
