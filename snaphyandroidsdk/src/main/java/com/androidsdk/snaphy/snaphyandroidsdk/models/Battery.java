...
public class Battery extends Model {
    ...
    public Battery (){
        that = this;
                ...
                public void setBatteryNumber(String batteryNumber){
                    ...
                    hashMap.put("batteryNumber", batteryNumber);
                }
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      BatteryRepository lowercaseFirstLetterRepository = (BatteryRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public Customer getCustomer() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(customer == null){
                                        BatteryRepository batteryRepository = (BatteryRepository) getRepository();

                                        RestAdapter restAdapter = batteryRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__customer( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Customer> callback) {
                                        ...
                                        //Define methods here..
                                        final BatteryRepository  batteryRepo = restAdapter.createRepository(BatteryRepository.class);
                                        ...
                                        batteryRepo.get__customer( (String)that.getId(), refresh,  new ObjectCallback<Customer> (){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__vehicleInfo( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<VehicleInfo> callback) {
                                        ...
                                        batteryRepo.get__vehicleInfo( (String)that.getId(), refresh,  new ObjectCallback<VehicleInfo> (){
