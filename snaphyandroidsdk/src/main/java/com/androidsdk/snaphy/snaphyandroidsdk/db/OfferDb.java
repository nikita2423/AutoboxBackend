...
public class OfferDb{
  ...
  public OfferDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public DataList<Offer>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit) {
        DataList<Offer> modelList = new DataList<Offer>();
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM Offer " + whereQuery + " LIMIT " + limit;
            }else{
                selectQuery = "SELECT  * FROM Offer " + whereQuery;
            }
        }
    ...
    // Getting All Data where
    public DataList<Offer>  getAll__db(HashMap<String, Object> whereKeyValue, int limit) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `Offer` " + whereQuery + " LIMIT " + limit;
            }else{
                countQuery = "SELECT  * FROM `Offer` " + whereQuery;
            }
        }
