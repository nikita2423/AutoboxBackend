...
public class ServiceBookingRepository extends ModelRepository<ServiceBooking> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:serviceBookingId/vehicleDetail", "GET"), "ServiceBooking.prototype.__get__vehicleDetail");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:serviceBookingId/vehicleInfo", "GET"), "ServiceBooking.prototype.__get__vehicleInfo");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            public void get__vehicleDetail(  String serviceBookingId,  Boolean refresh, final ObjectCallback<VehicleDetail> callback){
            ...
            public void get__vehicleInfo(  String serviceBookingId,  Boolean refresh, final ObjectCallback<VehicleInfo> callback){
