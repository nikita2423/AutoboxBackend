...
public class CarModel extends Model {
    ...
    public CarModel (){
        that = this;
                ...
                private Map<String, Object> quoteImage;
                /* Adding Getter and Setter methods */
                public Map<String, Object> getQuoteImage(){
                    return quoteImage;
                }

                /* Adding Getter and Setter methods */
                public void setQuoteImage(Map<String, Object> quoteImage){
                    this.quoteImage = quoteImage;
                    //Update Map value..
                    hashMap.put("quoteImage", quoteImage);
                }
    ...
    public void destroy(final com.strongloop.android.loopback.callbacks.VoidCallback callback){
      CarModelRepository lowercaseFirstLetterRepository = (CarModelRepository) getRepository();
    ...
    //Now adding relations between related models
                    ...
                    public Brand getBrand() {
                        try{
                          //Adding database method for fetching from relation if not present..
                                      if(brand == null){
                                        CarModelRepository carModelRepository = (CarModelRepository) getRepository();

                                        RestAdapter restAdapter = carModelRepository.getRestAdapter();
                                        if(restAdapter != null){
                    ...
                    //Now add instance methods to fetch the related belongsTo Model..
                                    ...
                                    public void get__brand( Boolean refresh,  RestAdapter restAdapter, final ObjectCallback<Brand> callback) {
                                        ...
                                        //Define methods here..
                                        final CarModelRepository  carModelRepo = restAdapter.createRepository(CarModelRepository.class);
                                        ...
                                        carModelRepo.get__brand( (String)that.getId(), refresh,  new ObjectCallback<Brand> (){
