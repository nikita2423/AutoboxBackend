...
import android.content.Context;
import com.androidsdk.snaphy.snaphyandroidsdk.db.ImportDataDb;
...
public class ImportDataRepository extends ModelRepository<ImportData> {
    ...
    public ImportDataRepository(){
        super("ImportData", null, ImportData.class);
    ...
    public ImportDataDb getDb() {
      return importDataDb;
    }

    public void setImportDataDb(ImportDataDb importDataDb) {
      this.importDataDb = importDataDb;
    }

    private ImportDataDb importDataDb;
    ...
    public void addStorage(Context context){
         ...
         setImportDataDb(new ImportDataDb(context, DATABASE_NAME, getRestAdapter()));
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/", "GET"), "ImportData.getContainers");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/", "POST"), "ImportData.createContainer");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:container", "DELETE"), "ImportData.destroyContainer");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:container", "GET"), "ImportData.getContainer");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:container/files", "GET"), "ImportData.getFiles");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:container/files/:file", "GET"), "ImportData.getFile");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:container/files/:file", "DELETE"), "ImportData.removeFile");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:container/upload", "POST"), "ImportData.upload");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:container/download/:file", "GET"), "ImportData.download");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getSchema", "POST"), "ImportData.getSchema");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getAbsoluteSchema", "POST"), "ImportData.getAbsoluteSchema");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getDetailSchema", "POST"), "ImportData.getDetailSchema");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/getModelRelationSchema", "POST"), "ImportData.getModelRelationSchema");
