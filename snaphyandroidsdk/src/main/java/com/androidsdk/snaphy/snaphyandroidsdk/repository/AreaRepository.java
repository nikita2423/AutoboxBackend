...
public class AreaRepository extends ModelRepository<Area> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/:areaId/country", "GET"), "Area.prototype.__get__country");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            public void get__country(  String areaId,  Boolean refresh, final ObjectCallback<Country> callback){
