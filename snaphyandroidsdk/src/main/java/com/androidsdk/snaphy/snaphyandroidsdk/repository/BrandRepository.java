...
public class BrandRepository extends ModelRepository<Brand> {
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/findAll", "POST"), "Brand.findAll");
    ...
    contract.addItem(new RestContractItem("/" + getNameForRestUrl() + "/saveTrendingBrand", "POST"), "Brand.saveTrendingBrand");
...
//override getNameForRestUrlMethod
    public String  getNameForRestUrl() {
            ...
            public void findAll(  Map<String,  ? extends Object> ctx,  Object filter,  String lastDate, final ObjectCallback<JSONObject>  callback ){
            ...
            //Method saveTrendingBrand definition
            public void saveTrendingBrand(  Map<String,  ? extends Object> ctx,  String brandId, final ObjectCallback<JSONObject>  callback ){
                ...
                */
                ...
                //Now add the arguments...
                    ...
                    invokeStaticMethod("saveTrendingBrand", hashMapObject, new Adapter.JsonObjectCallback() {
            ...
            }//Method saveTrendingBrand definition ends here..
