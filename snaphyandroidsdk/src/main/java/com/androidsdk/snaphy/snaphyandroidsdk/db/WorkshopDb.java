...
public class WorkshopDb{
  ...
  public WorkshopDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public DataList<Workshop>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit) {
        DataList<Workshop> modelList = new DataList<Workshop>();
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM Workshop " + whereQuery + " LIMIT " + limit;
            }else{
                selectQuery = "SELECT  * FROM Workshop " + whereQuery;
            }
        }
    ...
    // Getting All Data where
    public DataList<Workshop>  getAll__db(HashMap<String, Object> whereKeyValue, int limit) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit){
        ...
        if(orderBy != null){
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `Workshop` " + whereQuery + " LIMIT " + limit;
            }else{
                countQuery = "SELECT  * FROM `Workshop` " + whereQuery;
            }
        }
