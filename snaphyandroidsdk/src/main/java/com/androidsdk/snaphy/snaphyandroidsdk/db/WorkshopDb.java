...
public class WorkshopDb{
  ...
  public WorkshopDb(Context context, String DATABASE_NAME, RestAdapter restAdapter){
    ...
    public void insert__db (final String id, final Workshop _modelData) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      // Inserting Row
      ContentValues values = getContentValues(_modelData);
      db.insert("`Workshop`", null, values);
    }
    ...
    public ContentValues getContentValues(Workshop _modelData){
      ContentValues values = new ContentValues();
                       
                                                            String dealershipNameData = "";
                        if(_modelData.getDealershipName() != null){
                          dealershipNameData = _modelData.getDealershipName().toString();
                          values.put("`dealershipName`", dealershipNameData);
                        }
                        ...
                        if(_modelData.getStatus() != null){
                          ...
                          values.put("`status`", statusData);
                                                            ...
                                                            String consultantNameData = "";
                        if(_modelData.getConsultantName() != null){
                          consultantNameData = _modelData.getConsultantName().toString();
                          values.put("`consultantName`", consultantNameData);
                        }
                        ...
                        if(_modelData.getManagerImage() != null){
                          ...
                          values.put("`managerImage`", managerImageData);
                                                            ...
                                                            String workshopNumberData = "";
                        if(_modelData.getWorkshopNumber() != null){
                          workshopNumberData = _modelData.getWorkshopNumber().toString();
                          values.put("`workshopNumber`", workshopNumberData);
                        }
    ...
    // Getting single c
    public   Workshop get__db(String id) {
        if (id != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("Workshop", null, "id=?", new String[]{id}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    ...
                    if (hashMap != null) {
                        WorkshopRepository repo = restAdapter.createRepository(WorkshopRepository.class);
                        repo.addStorage(context);
                        return (Workshop)repo.createObject(hashMap);
                    } else {
                        return null;
                    }
                }
    ...
    // Getting single cont
    public   Workshop get__db(String whereKey, String whereKeyValue) {
        if (whereKeyValue != null) {
            SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
            Cursor cursor = db.query("`Workshop`", null, "`" + whereKey + "` =?", new String[]{whereKeyValue}, null, null, null, null);
            if (cursor != null) {
                if (!cursor.moveToFirst() || cursor.getCount() == 0){
                    return null;
                }else{
    ...
    private HashMap<String, Object> parseCursor(Cursor cursor ){
      HashMap<String, Object> hashMap = new HashMap<>();
                        ...
                        if(cursor.getString(0) != null){
                          dealershipNameData = cursor.getString(0);
                          if(dealershipNameData != null){
                            dealershipNameData = (String)dealershipNameData;
                            hashMap.put("dealershipName", dealershipNameData);
                          }
                        }
                        ...
                        if(cursor.getString(2) != null){
                          consultantNameData = cursor.getString(2);
                          if(consultantNameData != null){
                            consultantNameData = (String)consultantNameData;
                            hashMap.put("consultantName", consultantNameData);
                          }
                        }
                        ...
                        if(cursor.getString(9) != null){
                          ...
                          gsonBuilder.setLongSerializationPolicy(LongSerializationPolicy.STRING);
                          Gson gson = gsonBuilder.create();
                           timingsData = gson.fromJson(cursor.getString(9), Map.class);
                          if(timingsData != null){
                        ...
                        if(cursor.getString(10) != null){
                          ...
                          gsonBuilder.setLongSerializationPolicy(LongSerializationPolicy.STRING);
                          Gson gson = gsonBuilder.create();
                           managerImageData = gson.fromJson(cursor.getString(10), Map.class);
                        ...
                        if(cursor.getString(11) != null){
                          workshopNumberData = cursor.getString(11);
                          if(workshopNumberData != null){
                            workshopNumberData = (String)workshopNumberData;
                            hashMap.put("workshopNumber", workshopNumberData);
                          }
                        }
    ...
    public void upsert__db(String id, Workshop model){
        if(count__db(id) != 0){
            update__db(id, model);
        }else{
            insert__db(id, model);
    ...
    public DataList<Workshop>  getAll__db() {
        DataList<Workshop> modelList = new DataList<Workshop>();
        // Select All Query
        String selectQuery = "SELECT  * FROM `Workshop`";

        SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
        //http://www.tothenew.com/blog/sqlite-locking-and-transaction-handling-in-android/
        Cursor cursor = db.rawQuery(selectQuery, null);
        if (!cursor.moveToFirst() || cursor.getCount() == 0){
            return (DataList<Workshop>) modelList;
        }else{
            do {
                ...
                if(hashMap != null){
                    WorkshopRepository repo = restAdapter.createRepository(WorkshopRepository.class);
                    repo.addStorage(context);
                    modelList.add((Workshop)repo.createObject(hashMap));
                }
    ...
    public DataList<Workshop>  getAll__db(HashMap<String, Object> whereKeyValue) {
    ...
    public DataList<Workshop>  getAll__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip) {
        DataList<Workshop> modelList = new DataList<Workshop>();
        String whereQuery = getWhereQuery(whereKeyValue);
        String selectQuery;
        if(orderBy != null){
            selectQuery = "SELECT  * FROM `Workshop` " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
            ...
            if(limit != 0){
                // Select All Query
                selectQuery = "SELECT  * FROM Workshop " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
            }else{
                selectQuery = "SELECT  * FROM Workshop " + whereQuery  + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    // Getting All Data where
    public DataList<Workshop>  getAll__db(HashMap<String, Object> whereKeyValue, int limit, int skip) {
    ...
    public int count__db(HashMap<String, Object> whereKeyValue, String orderBy, int limit, int skip){
        ...
        String countQuery;
        if(orderBy != null){
            countQuery = "SELECT  * FROM `Workshop` " + whereQuery  + " ORDER BY " + orderBy ;
            if(limit != 0){
                // Select All Query
            ...
            if(limit != 0){
                // Select All Query
                countQuery = "SELECT  * FROM `Workshop` " + whereQuery + " LIMIT " + limit + " OFFSET " + skip;
            }else{
                countQuery = "SELECT  * FROM `Workshop` " + whereQuery + " LIMIT -1 OFFSET " + skip;
            }
        }
    ...
    public void checkOldData__db(final HashMap<String, Object> whereKeyValue) {
            ...
            // updating row
            db.update("`Workshop`", values, "_DATA_UPDATED = 1 AND " + where, null);
    }
    ...
    public void deleteOldData__db(final HashMap<String, Object> whereKeyValue) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      String where = getWhere(whereKeyValue);
      db.delete("`Workshop`", "_DATA_UPDATED = 0 AND " + where , null);
    }
    ...
    // Getting All Data where
    public DataList<Workshop>  getAll__db(String whereKey, String whereKeyValue) {
        DataList<Workshop> modelList = new DataList<Workshop>();
        // Select All Query
        String selectQuery = "SELECT  * FROM `Workshop` WHERE `" + whereKey +"` ='"+ whereKeyValue + "'" ;
    ...
    public int count__db(String whereKey, String whereKeyValue){
      String countQuery = "SELECT  * FROM `Workshop` WHERE `" + whereKey +"` ='"+ whereKeyValue + "'" ;
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getReadableDatabase();
      Cursor cursor = db.rawQuery(countQuery, null);
      int count = cursor.getCount();
      cursor.close();
    ...
    public void checkOldData__db(final String whereKey, final String whereKeyValue) {
      ...
      values.put("_DATA_UPDATED", 0);
      // updating row
      db.update("`Workshop`", values, "_DATA_UPDATED = 1 AND `" + whereKey + "` = ?", new String[]{whereKeyValue});
    }
    ...
    public void deleteOldData__db(final String whereKey, final String whereKeyValue) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      db.delete("`Workshop`", "_DATA_UPDATED = 0 AND `" + whereKey + "` = ?", new String[]{whereKeyValue});
    }


    //Update multiple data at once..
    public void updateAll__db(final HashMap<String, Object> whereKeyValue, final Workshop _modelData ){
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      ContentValues values = getContentValues(_modelData);
      String where = getWhere(whereKeyValue);
      db.update("`Workshop`", values, where, null);
    }
    ...
    public void update__db(final String id,   final Workshop _modelData) {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      ContentValues values = getContentValues(_modelData);
      // updating row
      db.update("`Workshop`", values, "id = ?", new String[] { id });
    }
    ...
    public void checkOldData__db() {
      ...
      values.put("_DATA_UPDATED", 0);
      // updating row
      db.update("`Workshop`", values, "_DATA_UPDATED = 1", null);
    }
    ...
    public void deleteOldData__db() {
      SQLiteDatabase db = DbHandler.getInstance(context, DATABASE_NAME).getWritableDatabase();
      db.delete("`Workshop`", "_DATA_UPDATED = 0", null);
    }
